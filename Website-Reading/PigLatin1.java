                            ...
                            if (line.substring(h, h+1).equals(" ")){
                                ...
                                if (wordL > 2){
                                    for (int i = 0; i < consonant.length; i++){
                                        if (line.substring(h-wordL+1, h+2-wordL).toLowerCase().equals(consonant[i])){
                                            for (int j = 1; j < wordL-1; j++){
                                                System.out.print(line.substring(h-wordL+1+j, h-wordL+2+j));
                                            }
                                            System.out.print(line.substring(h+1-wordL, h+2-wordL) + "ay");
                                        }
                                    }
                                    for (int i = 0; i < vowel.length; i++){
                                        if (line.substring(h-wordL+1, h+2-wordL).toLowerCase().equals(vowel[i])){
                                            for (int j = 0; j < wordL-2; j++){
                                                System.out.print(line.substring(h-wordL+1+i, h-wordL+2+i));
                                            }
                                            System.out.print("ay");
                                        }
                                    }
